          ...
          <NavLink to={`/blog/1`} className="group w-full min-h-[345px] rounded-xl overflow-hidden hover:shadow-lg transition-shadow duration-300 bg-white">
               ...
               <div className="p-4">
                    ...
                    <p className="font-[600] text-second line-clamp-2">
                         The Pros and Cons of Open vs.
                         Enclosed Car Transport: Which Is Right
                         for You?
                    </p>
                    ...
                    <button className="relative flex gap-2 items-center justify-center mt-5">
                         ...
                         <FontAwesomeIcon icon={faArrowRight} className="text-second transition-transform duration-300 group-hover:translate-x-1" />
                    </button>
               </div>
          </NavLink>
     );
